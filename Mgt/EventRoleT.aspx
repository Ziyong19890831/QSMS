<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Mgt.master" AutoEventWireup="true" CodeFile="EventRoleT.aspx.cs" Inherits="Mgt_EventRole" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="path txtS mb20">現在位置：<a href="#">系統功能管理</a> <i class="fa fa-angle-right"></i><a href="EventRoleT.aspx">22縣市報名管理</a></div>
    ...
    <div class="both mb20">
        <fieldset>
            ...
            <div class="right">
                ...
                <input name="btnInsert" type="button" value="新增" onclick="location.href = 'EventRoleT_AE.aspx?Work=N'" />
            </div>
        </fieldset>
    </div>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="修改規則" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                     ...
                     <a href='./EventRoleTDetail.aspx?sno=<%#Eval("ERSNO").ToString() %>'><i class="fa fa-pen-square"></i></a>
            ...
            <asp:TemplateField HeaderText="修改" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <a href='./EventRoleT_AE.aspx?a=<%=Request.QueryString["a"] %>&n=NN&sno=<%#Eval("ERSNO").ToString() %>'><i class="fa fa-pen-square"></i></a>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center"></ItemStyle>
            </asp:TemplateField>
