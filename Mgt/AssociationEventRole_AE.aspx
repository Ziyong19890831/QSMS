<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Mgt.master" AutoEventWireup="true" CodeFile="AssociationEventRole_AE.aspx.cs" Inherits="Mgt_AssociationEventRole_AE" %>
    ...
    <table>
        <tr>
            ...
            <td>
                ...
                <br />
                <asp:TextBox ID="txt_AERName" class="required w10" runat="server" MaxLength="50"></asp:TextBox><br />
            </td>
        </tr>
        <tr>
        ...
        <input name="btnCancel" type="button" value="取消" onclick="location.href='AssociationEventRole.aspx';"/>
    </div>
</asp:Content>
