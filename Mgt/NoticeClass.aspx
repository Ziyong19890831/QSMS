<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Mgt.master" AutoEventWireup="true" CodeFile="NoticeClass.aspx.cs" Inherits="Mgt_NoticeClass" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="path txtS mb20">現在位置：<a href="#">常用服務管理</a> <i class="fa fa-angle-right"></i><a href="NoticeClass.aspx">公告分類設定</a></div>
    ...
    <div class="both mb20">
        <fieldset>
            ...
            <div class="right">
                ...
                <input name="btnInsert" type="button" value="新增" onclick="location.href = 'NoticeClass_AE.aspx?Work=N'" />
                <% } %>
            </div>
        </fieldset>
    </div>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="修改" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    ...
                    <a href='./NoticeClass_AE.aspx?a=<%=Request.QueryString["a"] %>&n=NN&sno=<%# Eval("NoticeCSNO").ToString()%>'><i class="fa fa-pen-square"></i></a>
                    <% } else { %>
                        無權限
                    <% } %>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="刪除" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <% if (userInfo.AdminIsUpdate == true) { %>
                    <asp:LinkButton ID='btnDEL' runat="server" OnClientClick="return confirm('是否刪除?');" OnClick='btnDEL_Click' CommandArgument='<%# Eval("NoticeCSNO")%>'><i class="fa fa-trash"></i></asp:LinkButton>
                    <% } else { %>
                        無權限
                    <% } %>
                </ItemTemplate>
