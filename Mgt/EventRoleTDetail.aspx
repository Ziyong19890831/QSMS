<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Mgt.master" AutoEventWireup="true" CodeFile="EventRoleTDetail.aspx.cs" Inherits="Mgt_EventRoleDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="center btns">
        ...
        <input name="btnCancel" type="button" value="取消" onclick="location.href = 'EventRoleT.aspx';" />
    </div>
