<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Mgt.master" AutoEventWireup="true" CodeFile="ExChangeEvent_Local.aspx.cs" Inherits="Mgt_ExChangeEvent_Local" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="path txtS mb20">現在位置：<a href="#">繼續教育管理</a> <i class="fa fa-angle-right"></i><a href="ExChangeEvent_Local.aspx">繼續教育報名管理-22縣市</a></div>
    ...
    <div class="both mb20">
        <fieldset>
            ...
            <div class="right">
                ...
                <input name="btnInsert" type="button" value="新增" onclick="location.href = 'EventLocal_AE.aspx?Work=N&&Exchange=1'" />
                <% } %>
            </div>
        </fieldset>
    </div>
       ...
       <%--     <asp:TemplateField HeaderText="名單" ItemStyle-HorizontalAlign="Center">
            ...
            <asp:TemplateField HeaderText="審核" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    ...
                    <%# ( Convert.ToDateTime(Eval("StartTime")) <= DateTime.Today                          
                        ...
                        "<a href='./EventAudit.aspx?a=" +Request.QueryString["a"] + "&n=NN&sno="+Eval("EventSNO").ToString()+" &Exchange=1&twenty=1'><i class='fa fa-pen-square' aria-hidden='true'></i></a>"                  
                        : "尚未到期"
                    %>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center"></ItemStyle>
            ...
            <asp:TemplateField HeaderText="修改" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    ...
                    <a href='./EventLocal_AE.aspx?a=<%=Request.QueryString["a"] %>&n=NN&&Exchange=1&sno=<%#Eval("EventSNO").ToString() %>&csno=<%#Eval("id").ToString() %>'><i class="fa fa-pen-square"></i></a>
                    <% } else { %>
                         無權限
                    <% } %>
                </ItemTemplate>
