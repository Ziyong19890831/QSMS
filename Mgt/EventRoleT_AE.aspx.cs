...
public partial class Mgt_EventRole_AE : System.Web.UI.Page
{
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        if (Work.Value.Equals("NEW"))
        {
            ...
            ", aDict);
            Response.Write("<script>alert('新增成功!');document.location.href='./EventRoleT.aspx'; </script>");
        }
        else
        {
            ...
            Response.Write("<script>alert('修改成功!');document.location.href='./EventRoleT.aspx'; </script>");
        }
    }
}