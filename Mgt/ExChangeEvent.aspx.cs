...
public partial class Mgt_ExChangeEvent : System.Web.UI.Page
{
    ...
    protected void bindData(int page)
    {
        ...
        String sql = @"
            SELECT ROW_NUMBER() OVER (ORDER BY E.EventSNO DESC) as ROW_NO,
                E.EventSNO,EC.ClassName,E.EventName,E.StartTime,E.EndTime,C.id,
                E.CPerosn,E.CountLimit,G.Mval as Class1,G.PVal as Class1Code,F.Mval as Class2,F.PVal as Class2Code,
                (Select count(1) From EventD ed Where ed.EventSNO=E.EventSNO) pCount,EB.EventBSNO
            FROM Event E
