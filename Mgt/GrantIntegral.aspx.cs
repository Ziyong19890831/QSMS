...
public partial class Mgt_GrantIntegral : System.Web.UI.Page
{
    ...
    protected void bindData(int page)
    {
        ...
        string sql = @"  
                	...
                	getAllParts As (
						...
						where QC.Class1=1 or QC.Class1=2
                	)
                	...
                	, getFinishedExam As (
                		...
                		ls.IsPass=1 and QC.Class1=1 or QC.Class1=2
                	) 
                	...
                	, getCourseSNO As (
                		...
                		From QS_CourseELearningSection ces
							...
							Where c.Class1=1 or c.Class1=2
                	) 
                	...
                	, getAllFinishedCourse As (
                		...
                		where c.CourseSNO is not null and Qc.Class1=1 or Qc.Class1=2
                	) ,getallData as(
                    --取得所有學員的E-Learning紀錄
						...
						Select  ROW_NUMBER() OVER (ORDER BY gd.personSNO) AS ROW_NO,*,STUFF ( P.PersonID , 4 , 3 , 'OOO' ) as 'PersonID_encryption'	
						from getallData gd
