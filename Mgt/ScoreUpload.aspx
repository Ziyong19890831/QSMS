<%@ Page Language="C#" MasterPageFile="~/MasterPage/Mgt.master" AutoEventWireup="true" CodeFile="ScoreUpload.aspx.cs" Inherits="Mgt_ScoreUpload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="path txtS mb20">現在位置：新訓課程時數上傳<i class="fa fa-angle-right"></i><a href="ScoreUpload.aspx">新訓課程時數上傳</a></div>
    <div id="tabs" style="margin-bottom: 10px;" >
        <ul>
            <li class="hide" id="tab1" runat="server"><a href="#tabs-1">新訓課程時數上傳</a></li>
