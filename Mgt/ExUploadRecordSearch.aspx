<%@ Page Language="C#" MasterPageFile="~/MasterPage/Mgt.master"  AutoEventWireup="true" CodeFile="ExUploadRecordSearch.aspx.cs" Inherits="Mgt_ExUploadRecordSearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="path txtS mb20">現在位置：<a href="#">繼續教育管理</a> <i class="fa fa-angle-right"></i><a href="ExUploadRecordSearch.aspx">繼續教育課程時數上傳查詢</a></div>
       <div id="tabs" style="margin-bottom: 10px;">
        <ul>
            <li class="hide" visible="false" id="tab1" runat="server"><a href="#tabs-1">繼續教育時數上傳</a></li>
            <li class="hide" id="tab2" runat="server"><a href="#tabs-2">繼續教育課程時數上傳紀錄查詢</a></li>
        </ul>
