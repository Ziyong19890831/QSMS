<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Mgt.master" AutoEventWireup="true" CodeFile="GrantIntegral.aspx.cs" Inherits="Mgt_GrantIntegral" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="path txtS mb20">現在位置：<a href="#">系統功能管理</a> <i class="fa fa-angle-right"></i><a href="RecordLog.aspx">證書積分授予</a></div>
    ...
    <asp:UpdatePanel ID="Up1" runat="server">
        <ContentTemplate>
            ...
            <asp:GridView ID="gv_LearningRecord" runat="server" AutoGenerateColumns="False" OnRowCommand="gv_LearningRecord_RowCommand" OnRowCreated="gv_LearningRecord_RowCreated" OnRowDataBound="gv_LearningRecord_RowDataBound">
                <Columns>
