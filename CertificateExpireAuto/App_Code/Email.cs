...
public class Email
{
    ...
    /// 3.信件內容
    /// </summary>
    public static string SendList(string EventName, string sn, string Content)
    {
        #region 建立活動且發送信件
        ...
        using (WebClient webClient = new WebClient())
        {
            ...
            webClient.Headers.Add("x-api-key", "NDAyODIzZGY2ZGZlY2Q0NDAxNmUyMGVmODU4YTA1NzMtMTU4MzEyOTQ5Mw==");
            Thread.Sleep(6000);
            string task = webClient.UploadString("https://api.newsleopard.com/v1/campaign/normal/submit", results);
            return task;
        }
