<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/PDDI.Web.master" AutoEventWireup="true" CodeFile="GetPassword.aspx.cs" Inherits="Mgt_getPassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row mt10">
        ...
        <div class="col-12 center">
            <input name="btn_Reset" type="button" class="btn btn-success" value="寄送忘記密碼信件" runat="server" onserverclick="btn_Reset_Click" />
